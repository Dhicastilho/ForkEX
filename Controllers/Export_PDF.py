...
class Criar_PDF():
    ...
    def gerar_pdf(self, tx_final, tabela, natureza, risco, linha, n_linha, prazo, nome):
        self.fpdf.add_page()
        ...
        self.fpdf.ln(10)
        self.fpdf.cell(0, 10, f'Cooperado: {nome}', ln=True)
        ...
        # Salvar PDF
        pdf_path = f'Export/Simulação_{nome[:20]}.pdf'
        self.fpdf.output(pdf_path)
        
        # Retornar o caminho do PDF gerado
        return pdf_path

    def gerar_pdf_com_desc(self, tx_desc, tabela, natureza, risco, linha, n_linha, prazo, nome):
        self.fpdf.add_page()
        ...
        # Salvar PDF
        pdf_path = f'Export/Simulação_com_desc_{nome[:20]}.pdf'
        self.fpdf.output(pdf_path)
