...
class Login():
    ...
    def registrar_novo_usuario(self):
        ...
        st.markdown("<h2 style='text-align: center; color: #C9D200;'>Registrar Novo Usuário</h2>", unsafe_allow_html=True)
    ...
    def apagar_usuario(self):
        ...
        st.markdown("<h2 style='text-align: center; color: #C9D200;'>Apagar Usuário</h2>", unsafe_allow_html=True)
    ...
    def editar_usuario(self):
        ...
        st.markdown("<h2 style='text-align: center; color: #C9D200;'>Editar Usuário</h2>", unsafe_allow_html=True)
    ...
    def mostrar_usuarios(self):
        ...
        try:
            ...
            usuarios = self.conn.execute('SELECT email FROM usuarios').fetchall()
            
            if usuarios:
                # Converte a lista de tuplas em um DataFrame do Pandas para exibição
                df = pd.DataFrame(usuarios, columns=['Email'])
